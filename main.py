...
# ক্রেডেনশিয়ালস
API_TOKEN = '8675264448:AAHD9sohVSg3TCOusW_958D8PLrS_wl0KIo'
SUPERADMIN_ID = 6922039299  # প্রধান সুপারঅ্যাডমিন আইডি
...
def show_support_info(message):
    ...
    markup.add(ibtn("Contact Support", url="https://t.me/NETBOLDNETMAIR0", style="success", custom_emoji_id=get_emj_id("support")))
